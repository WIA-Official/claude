...
class WIANeuralEngine {
    ...
    drawTriangleMarkers() {
        ...
        this.ctx.beginPath();
        this.ctx.moveTo(this.size/2 - 15, 20);     // 위 왼쪽
        this.ctx.lineTo(this.size/2 + 15, 20);     // 위 오른쪽
        this.ctx.lineTo(this.size/2, 50);          // 아래 꼭짓점
        this.ctx.closePath();
        this.ctx.fill();
        ...
        this.ctx.beginPath();
        this.ctx.moveTo(30, this.size - 50);       // 위 꼭짓점
        this.ctx.lineTo(15, this.size - 20);       // 왼쪽 아래
        this.ctx.lineTo(45, this.size - 20);       // 오른쪽 아래
        this.ctx.closePath();
        this.ctx.fill();
        
        // 하단 우측 마커 (핑크) - 위를 가리키는 삼각형 ▲
        this.ctx.beginPath();
        this.ctx.moveTo(this.size - 30, this.size - 50);  // 위 꼭짓점
        this.ctx.lineTo(this.size - 45, this.size - 20);  // 왼쪽 아래
        this.ctx.lineTo(this.size - 15, this.size - 20);  // 오른쪽 아래
        this.ctx.closePath();
        this.ctx.fill();
